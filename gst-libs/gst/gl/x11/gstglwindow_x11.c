...
static void gst_gl_window_x11_get_window_dimensions (GstGLWindow * window, guint *width, guint
    *height);
...
gst_gl_window_x11_class_init (GstGLWindowX11Class * klass)
{
  ...
  window_class->get_window_dimensions =
      GST_DEBUG_FUNCPTR (gst_gl_window_x11_get_window_dimensions);
}
...
static void
gst_gl_window_x11_get_window_dimensions (GstGLWindow * window, guint *width, guint
    *height)
{
  GstGLWindowX11 *window_x11 = GST_GL_WINDOW_X11 (window);
  XWindowAttributes attr;
